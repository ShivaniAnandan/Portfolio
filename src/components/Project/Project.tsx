      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat unde ipsa laudantium saepe quam quasi.</p>
            </div>
            <footer> <ul className="tech-list"> <li>React</li>
                <li>Html</li>
                <li>css</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque facere laboriosam cupiditate dolore veritatis dicta quae, nulla alias ut similique!
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, optio.</h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi vitae ab blanditiis reprehenderit nam vel eaque fuga temporibus aliquid dolorum.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus, inventore!</h3>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam veniam accusamus optio iste praesentium temporibus odio! Quisquam fuga laboriosam consequatur odit dolor, dolore inventore dolores!</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</h3>
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aliquid laudantium, harum, neque officia unde amet error dolor ducimus placeat numquam natus ea vitae, earum quod obcaecati? Consequuntur, voluptatibus.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
